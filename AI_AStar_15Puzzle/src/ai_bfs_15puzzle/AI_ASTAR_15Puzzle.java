 ...
 * @author kksaikrishna
 */
public class AI_ASTAR_15Puzzle {
        ...
        for(int i=stateTree.size()-1; i>=0;)
            {
                ...
                System.out.println("Manhattan Distance:"+stateTree.get(i).getManhattanDistance());
                System.out.println("Number of Displaced Nodes:"+stateTree.get(i).getDisplacedTiles());
    ...
    public static void main(String[] args) 
    {
        ...
        stateTree = objSearchHandler.search(args[0],Integer.parseInt((args[1])));
